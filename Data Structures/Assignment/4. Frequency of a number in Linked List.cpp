/*
	Program to Frequency of a number in a Linked List
*/
#include<bits/stdc++.h>
using namespace std;
/*
...
int main()
{
	while(1)
	{
		...
		cout<<"4. Count any particular number in a linked List"<<endl;
		...
		switch(choice)
		{
			...
			case 4:
				{
					int count =0,num;
					cout<<endl<<"Enter number to count its frequency"<<endl;
					cin>>num;
					node * p = head;
					while(p!=NULL)
					{
					...
					cout<<"The frequency of the given number is = "<<count<<endl<<endl;
					break;
				}
			case 5:
				{
