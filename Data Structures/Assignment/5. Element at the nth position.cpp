/*
	Program to find the element at the nth position
*/
#include<bits/stdc++.h>
using namespace std;
/*
...
int main()
{
	while(1)
	{
		...
		cout<<"4. Diplay the element at the nth Position*******"<<endl;
			...
			case 4:
				{
					...
					else
					{
						int pos,n=0;
						bool flag=true;
						cout<<endl<<"Enter position to diplay element of that position"<<endl;
						cin>>pos;
						node *temp =head;
						while(temp!=NULL && n<=pos)
						{
							if(pos == n)
							{
								cout<<"Element at the position "<<pos<<" is  = "<<temp->data<<"  "<<endl;
								flag=false;
								break;
							}
							temp  = temp->next;
